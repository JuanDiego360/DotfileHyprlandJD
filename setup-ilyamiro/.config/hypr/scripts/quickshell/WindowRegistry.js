...
function getLayout(name, mx, my, mw, mh, userScale) {
    ...
    let base = {
        ...
        "productivity": { w: s(400, scale), h: s(580, scale), rx: mw - s(405, scale), ry: s(60, scale), comp: "productivity/ProductivityPopup.qml" },
        ...
        "calendar":  { w: s(1380, scale), h: s(600, scale), rx: Math.max(s(20, scale), Math.floor((mw/2)-(s(1380, scale)/2) - s(80, scale))), ry: s(60, scale), comp: "calendar/CalendarPopup.qml" },
