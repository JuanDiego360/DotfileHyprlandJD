                        ...
                        Rectangle {
                            ...
                            Item {
                                ...
                                Image {
                                    id: artImg
                                    anchors.fill: parent
                                    source: root.musicData.artUrl ? (root.musicData.artUrl.indexOf("http") === 0 || root.musicData.artUrl.indexOf("file://") === 0 ? root.musicData.artUrl : "file://" + root.musicData.artUrl) : ""
                                    fillMode: Image.PreserveAspectCrop
                                    visible: false 
                                }
                                Rectangle {
