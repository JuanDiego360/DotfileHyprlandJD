...
Variants {
    ...
    delegate: Component {
		...
		running: true
            ...
            property int focusTimeLeft: 1500
            ...
            Process {
                id: focusTimerTicker
                command: ["python3", Quickshell.env("HOME") + "/.config/hypr/scripts/quickshell/productivity/timer_helper.py", "tick"]
                stdout: StdioCollector {
                    onStreamFinished: {
                        let txt = this.text.trim();
                        if (txt !== "") {
                            try {
                                let data = JSON.parse(txt);
                                barWindow.focusTimeLeft = data.timeLeft;
                                barWindow.focusTimerRunning = data.running;
                            } catch(e) {
                                console.log("Error parsing timer tick in topbar: ", e);
                            }
                        }
                    }
                }
            ...
            Timer { 
                ...
                onTriggered: { 
                    focusTimerTicker.running = false; 
                    focusTimerTicker.running = true; 
                } 
            }
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            color: isHovered ? (barWindow.updateAvailable ? Qt.rgba(mocha.green.r, mocha.green.g, mocha.green.b, 0.15) : Qt.rgba(mocha.text.r, mocha.text.g, mocha.text.b, 0.10)) : "transparent"
                            radius: barWindow.s(10)
                            ...
                            Rectangle {
                                ...
                                color: mocha.green
                                z: -1
                                visible: barWindow.updateAvailable
                                
                                SequentialAnimation on scale {
                                    running: barWindow.updateAvailable && !updateButton.isHovered
                            ...
                            Text {
                                ...
                                text: "󰚰"
                                font.family: "Iosevka Nerd Font"; font.pixelSize: barWindow.s(22)
                                color: parent.isHovered ? mocha.text : (barWindow.updateAvailable ? mocha.green : mocha.overlay0)
                                Behavior on color { ColorAnimation { duration: 200 } }
                            ...
                            MouseArea {
                                ...
                                Row {
                                    ...
                                    Rectangle {
                                        ...
                                        Image { 
                                            anchors.fill: parent; 
                                            source: barWindow.displayArtUrl ? (barWindow.displayArtUrl.indexOf("http") === 0 || barWindow.displayArtUrl.indexOf("file://") === 0 ? barWindow.displayArtUrl : "file://" + barWindow.displayArtUrl) : ""; 
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        Row {
                            ...
                            Rectangle {
                                id: productivityPill
                                property bool isHovered: productivityMouse.containsMouse
                                color: isHovered ? Qt.rgba(mocha.surface1.r, mocha.surface1.g, mocha.surface1.b, 0.6) : Qt.rgba(mocha.surface0.r, mocha.surface0.g, mocha.surface0.b, 0.4)
                                radius: barWindow.s(10); height: sysLayout.pillHeight;
                                clip: true
                                
                                property real targetWidth: prodLayoutRow.implicitWidth + barWindow.s(24)
                                width: targetWidth
                                Behavior on width { NumberAnimation { duration: 500; easing.type: Easing.OutQuint } }
                                ...
                                property bool initAnimTrigger: false
                                Timer { running: rightContent.showLayout && !productivityPill.initAnimTrigger; interval: 20; onTriggered: productivityPill.initAnimTrigger = true }
                                opacity: initAnimTrigger ? 1 : 0
                                transform: Translate { y: productivityPill.initAnimTrigger ? 0 : barWindow.s(15); Behavior on y { NumberAnimation { duration: 500; easing.type: Easing.OutBack } } }
                                Behavior on opacity { NumberAnimation { duration: 400; easing.type: Easing.OutCubic } }
                                ...
                                Row { 
                                    ...
                                    Text { 
                                        ...
                                        color: barWindow.focusTimerRunning ? mocha.green : mocha.mauve
                                        Behavior on color { ColorAnimation { duration: 200 } }
                                    }
                                    Text { 
                                        anchors.verticalCenter: parent.verticalCenter; 
                                        text: barWindow.focusTimerRunning ? barWindow.formatFocusTime(barWindow.focusTimeLeft) : ""
                                        visible: barWindow.focusTimerRunning
                                        font.family: "JetBrains Mono"; 
                                        font.pixelSize: barWindow.s(13); 
                                        font.weight: Font.Black; 
                                        color: mocha.text 
                                ...
                                MouseArea { 
                                    id: productivityMouse; 
                                    anchors.fill: parent; 
                                    hoverEnabled: true; 
                                    onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/hypr/scripts/qs_manager.sh toggle productivity"])
                                }
                            }
