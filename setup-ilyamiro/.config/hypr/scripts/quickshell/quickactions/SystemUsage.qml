...
Item {
    ...
    property real rawGpu: isNaN(SysData.gpu) ? 0.0 : SysData.gpu / 100.0
    property real gpuUsage: rawGpu
    ...
    Item {
        ...
        LiquidSquare {
            ...
            y: root.cellY(0.333)
            width: root.cellW(0.0, 0.5)
            height: root.cellH(0.333, 0.333)
            
            value: root.gpuUsage
            colorFill: Qt.lighter(root.cMauve, 1.1) 
            icon: "󰢮" 
            title: "GPU"
        ...
        LiquidSquare {
            ...
            colorFill: Qt.darker(root.cMauve, 1.1) 
            icon: "\uF2C9"
            title: "GPU TEMP"
