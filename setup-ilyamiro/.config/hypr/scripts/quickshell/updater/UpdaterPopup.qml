...
`
    ...
    Rectangle {
        id: mainCard
        width: window.uiExpanded ? window.s(950) : window.s(540)
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Rectangle {
                    id: systemUpdateBtn
                    Layout.preferredWidth: window.s(210) 
                    Layout.preferredHeight: window.s(54)
                    radius: window.s(12)
                    color: window.surface0
                    border.color: sysBtnMa.containsMouse ? window.blue : window.surface2
                    border.width: sysBtnMa.containsMouse ? window.s(2) : 1
                    clip: true
                    
                    scale: sysBtnMa.pressed ? 0.98 : (sysBtnMa.containsMouse ? 1.01 : 1.0)
                    ...
                    Canvas {
                        ...
                        NumberAnimation on wavePhase {
                            running: systemUpdateBtn.fillLevel > 0.0 && systemUpdateBtn.fillLevel < 1.0
                            loops: Animation.Infinite
                            from: 0; to: Math.PI * 2
                            duration: 1000
                        }
                        ...
                        Connections { target: systemUpdateBtn; function onFillLevelChanged() { sysWaveCanvas.requestPaint() } }
                        
                        onPaint: {
                            var ctx = getContext("2d");
                            ctx.clearRect(0, 0, width, height);
                            if (systemUpdateBtn.fillLevel <= 0.001) return;

                            var currentW = width * systemUpdateBtn.fillLevel;
                            var r = window.s(12);
                            ...
                            if (systemUpdateBtn.fillLevel < 0.99) {
                                var waveAmp = window.s(8) * Math.sin(systemUpdateBtn.fillLevel * Math.PI); 
                            ...
                            grad.addColorStop(0, Qt.darker(window.blue, 1.1).toString());
                            grad.addColorStop(1, window.blue.toString());
                            ctx.fillStyle = grad;
                            ctx.fill();
                    ...
                    RowLayout {
                        ...
                        Text { 
                            ...
                            color: systemUpdateBtn.fillLevel > 0.5 ? window.crust : window.blue 
                            Behavior on color { ColorAnimation { duration: 150 } }
                        }
                        
                        Text { 
                            text: systemUpdateBtn.fillLevel > 0 ? "HOLDING..." : "SYSTEM UPDATE"
                            font.family: "JetBrains Mono"
                            font.weight: Font.Black
                            font.pixelSize: window.s(13)
                            color: systemUpdateBtn.fillLevel > 0.5 ? window.crust : window.blue 
                    ...
                    MouseArea {
                        ...
                        anchors.fill: parent
                        hoverEnabled: true
                        cursorShape: systemUpdateBtn.triggered ? Qt.ArrowCursor : Qt.PointingHandCursor
                        
                        onPressed: {
                            if (!systemUpdateBtn.triggered) {
                                sysDrainAnim.stop();
                                sysFillAnim.start();
                            }
                        }
                        ...
                        onReleased: {
                            if (!systemUpdateBtn.triggered && systemUpdateBtn.fillLevel < 1.0) {
                                sysFillAnim.stop();
                                sysDrainAnim.start();
                            }
                        }
                    ...
                    NumberAnimation {
                        id: sysFillAnim
                        target: systemUpdateBtn
                        property: "fillLevel"
                        to: 1.0
                        duration: 1200 * (1.0 - systemUpdateBtn.fillLevel)
                    ...
                    NumberAnimation {
                        ...
                        property: "fillLevel"
                        to: 0.0
                        duration: 800 * systemUpdateBtn.fillLevel
                        easing.type: Easing.OutCubic
                    }
                }

                // Button 2: Dots Update
                Rectangle {
                    id: updateBtn
                    Layout.preferredWidth: window.s(210) 
                    Layout.preferredHeight: window.s(54)
                    ...
                    RowLayout {
                        ...
                        Text { 
                            text: updateBtn.fillLevel > 0 ? "HOLDING..." : "DOTS UPDATE"
                            font.family: "JetBrains Mono"
                            font.weight: Font.Black
                            font.pixelSize: window.s(13)
                            color: updateBtn.fillLevel > 0.5 ? window.crust : window.green 
