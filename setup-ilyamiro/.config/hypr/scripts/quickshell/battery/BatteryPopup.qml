...
Item {
    ...
    Process {
        id: sysPoller
        command: ["bash", "-c", 
            "val=$(cat /sys/class/power_supply/BAT*/capacity 2>/dev/null | head -n1); echo \"${val:-0}\"; " +
            "val2=$(cat /sys/class/power_supply/BAT*/status 2>/dev/null | head -n1); echo \"${val2:-Unknown}\"; " +
